...
class Figure:
    ...
    def __init__(self, *args):
        self.__sides = []
        # проверка на куб. Вообще это некрасиво и это надо как-нибудь делать в дочерних классах
        # но тогда надо добавлять дополнительные аргументы или атрибуты, которых нет в ТЗ
        default_value = 1
